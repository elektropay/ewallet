...
(function($)
{
	...
	Redactor.fn = $.Redactor.prototype = {
		...
		cleanConvertProtected: function(html)
		{
			...
			if (this.opts.htmlTags) html = html.replace(/<\?php([\w\W]*?)\?>/gi, '<section style="display: none;" rel="redactor-php-tag">$1</section>');
		...
		cleanReConvertProtected: function(html)
		{
			...
			// php tags convertation
			if (this.opts.htmlTags) html = html.replace(/<section style="display: none;" rel="redactor-php-tag">([\w\W]*?)<\/section>/gi, '<?php\r\n$1\r\n?>');
